...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { cidade_id: @empresa.cidade_id, info: @empresa.info, nome: @empresa.nome, setor_id: @empresa.setor_id }
    end
  ...
  test "should update empresa" do
    put :update, id: @empresa, empresa: { cidade_id: @empresa.cidade_id, info: @empresa.info, nome: @empresa.nome, setor_id: @empresa.setor_id }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
